...
const RejectedCard = ({ item }) => {
  const { tutorName, tutorEmail, title, feedback, rejectionReason } = item;
  return (
    <div>
      <div className="w-full space-y-3 px-4 py-3 bg-white text-white rounded-md shadow-md dark:bg-sky-950">
        <div className="flex items-center justify-between">
          <span className="text-sm font-light text-gray-800 dark:text-gray-400">
            {tutorEmail}
          </span>
          <span className="text-white">{tutorName}</span>
        </div>
